describe('Remove Liquidity', () => {
  it('redirects', () => {
    cy.visit('/remove/0xc277a41DcC301A8e0CEF80031728f6ad1152F8a0-0xF9bA5210F91D0474bd1e1DcDAeC4C58E359AaD85') // new add
    cy.url().should(
      'contain',
      '/remove/0xc277a41DcC301A8e0CEF80031728f6ad1152F8a0/0xF9bA5210F91D0474bd1e1DcDAeC4C58E359AaD85' // new add
    )
  })
  ...
  it('does not crash if ETH is duplicated', () => {
    cy.visit('/remove/0xc277a41DcC301A8e0CEF80031728f6ad1152F8a0-0xc277a41DcC301A8e0CEF80031728f6ad1152F8a0') // new add 
    cy.get('#remove-liquidity-tokena-symbol').should('contain.text', 'WETH')
