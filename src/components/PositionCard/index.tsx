import { JSBI, Pair, Percent } from 'hlbscswap-sdk'
            ...
            <FixedHeightRow>
              ...
              {token0Deposited ? (
                <RowFixed>
                  ...
                  <CurrencyLogo size="20px" style={{ marginLeft: '8px',color:'#fff' }} currency={currency0} />
                </RowFixed>
              ) : (
                '-'
              )}
            ...
            <FixedHeightRow>
              ...
              {token1Deposited ? (
                <RowFixed>
                  ...
                  <CurrencyLogo size="20px" style={{ marginLeft: '8px',color:'#fff' }} currency={currency1} />
                </RowFixed>
              ) : (
                '-'
              )}
