...
import { Currency, currencyEquals, ETHER, Percent, WETH } from 'hlbscswap-sdk'
    ...
    return (
      <AutoColumn gap={'md'} style={{ marginTop: '20px' }}>
        <RowBetween align="flex-end">
          ...
          <RowFixed gap="4px">
            <CurrencyLogo currency={currencyA} size={'24px'} style={{color:'#fff'}}/>
        ...
        <RowBetween align="flex-end">
          ...
          <RowFixed gap="4px">
            <CurrencyLogo currency={currencyB} size={'24px'} style={{color:'#fff'}}/>
            <Text fontSize={24} fontWeight={500} style={{ marginLeft: '10px' }} color="#fff">
              {currencyB?.symbol}
            </Text>
          </RowFixed>
        ...
        <Wrapper>
          ...
          <AutoColumn gap="md">
            <LightCard>
              <AutoColumn gap="20px">
                <RowBetween>
                  <Text fontWeight={500} color="#fff">总量</Text>
                  <ClickableText
                    fontWeight={500}
                    onClick={() => {
                ...
                <LightCard>
                  <AutoColumn gap="10px">
                    <RowBetween>
                      ...
                      <RowFixed>
                        <CurrencyLogo currency={currencyA} style={{ marginRight: '12px',color:'#fff' }} />
                        <Text fontSize={24} fontWeight={500} id="remove-liquidity-tokena-symbol" color="#fff">
                          {currencyA?.symbol}
                        </Text>
                      </RowFixed>
                    </RowBetween>
                    <RowBetween>
                      ...
                      <RowFixed>
                        <CurrencyLogo currency={currencyB} style={{ marginRight: '12px',color:'#fff' }} />
                        <Text fontSize={24} fontWeight={500} id="remove-liquidity-tokenb-symbol" color="#fff">
                          {currencyB?.symbol}
                        </Text>
                      </RowFixed>
                    </RowBetween>
